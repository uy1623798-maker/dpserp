...
export default function SchoolLogin(){
  ...
  return <main className="login rolelogin">
    <div className="loginbrand"><a href="/">← Back to website</a><img src={IMG}/><span className="kicker lighttxt">Secure school access</span><h1>Choose your <em>school portal.</em></h1><p>Separate, secure access for every member of the DPS community.</p><a className="fwdcredit" href="https://www.wetakefwd.online" target="_blank" rel="noreferrer" aria-label="Visit We Take FWD website"><span className="fwdmark" aria-hidden="true"><i/><i/><i/></span><span><b>WE TAKE<br/>FWD</b><small>Created and designed by WeTakeFWD</small><strong>www.wetakefwd.online</strong></span></a></div>
