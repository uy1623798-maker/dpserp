...
export default function SchoolLogin(){
  ...
  return <main className="login rolelogin">
    <div className="loginbrand"><a href="/">← Back to website</a><img src={IMG}/><span className="kicker lighttxt">Secure school access</span><h1>Choose your <em>school portal.</em></h1><p>Separate, secure access for every member of the DPS community.</p><a className="fwdcredit originalfwd" href="https://www.wetakefwd.online" target="_blank" rel="noreferrer" aria-label="Visit We Take FWD website"><img src="/wetakefwd-logo.svg" alt="We Take FWD"/><span><small>Created and designed by WeTakeFWD</small><strong>www.wetakefwd.online</strong></span></a></div>
